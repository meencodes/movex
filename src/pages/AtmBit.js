...
import Atm from '../assets/images/btm/atm.png'
        ...
        <div>
            ...
            <div className="cryptocurrency-hero-section white">
                <div className="cryptocurrency-hero-wrapper">
                    <img src={Atm} alt="Bitcoin Atm" className="image-24"/>
                    <div className="cryptocurrency-hero-content-wrapper">
                        <div className="hero-headings-wrapper white">
                            <h4 className="little-heading black cryptocurrency">The technology Bitcoin</h4>
                            <div className="big-heading-wrapper">
                                <Fade bottom>
                                    <h1 className="big-heading upper-hero black">
                                        CRYPTO
                                        <br />
                                        CURRENCY ATM
                                        <br />
