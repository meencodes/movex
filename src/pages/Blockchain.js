        ...
        <div className="coin-hero-content-wrapper">
          ...
          <div className="text-wrapper coin _2">
            ...
            <div className="text-block-5 coin">List up foreign exchange boards, join Coinmarketcap<br /><br />
              ...
              Coinmarketcap: Not an exchange board. But is one of the most recognized international websites Which collects information about currencies Cryptocurrency, whether it is a matter of market overview And the price of each currency Currencies that can be listed on That means that Coinmarketcap The currency coin has already passed the standards of the website itself, such as Bitcoin, Ethereum, XRP, Bitcoincash, Happycoin, etc. and the coin that is listed on Coinmarketcap is creating credibility for investors in the money market. Cryptocurrency Very much.</div>
          </div>
